        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {!loading && students.length === 0 && (
              <tr>
                <td colSpan={6} className="px-4 py-10 text-center text-slate">
                  No students match this search. Try clearing filters or add a new
                  record.
                </td>
              </tr>
            )}
                ...
                <tr key={s._id} className="border-b border-hairline last:border-0 hover:bg-black/[0.015]">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-1">
                      <button
                        className="p-1.5 border border-hairline hover:border-ink"
                      ...
                      <button
                        className="p-1.5 border border-hairline hover:border-rust hover:text-rust"
      ...
      {pagination && (
        <div className="flex items-center justify-between px-4 py-3 border-t border-hairline text-xs text-slate">
          <span>
            ...
            total student{pagination.total === 1 ? "" : "s"}
          </span>
          <div className="flex gap-1">
            <button
              className="p-1.5 border border-hairline disabled:opacity-40"
