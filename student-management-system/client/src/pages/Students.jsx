...
export default function Students() {
  ...
  const params = useMemo(
    () => ({ search, course, status, page, limit: PAGE_SIZE }),
    [search, course, status, page]
  );
  ...
  async function handleConfirmDelete() {
    try {
      ...
      // Keep dialog open; a toast/error banner could surface err.message here.
    }
  }
  ...
  return (
    <div className="space-y-5">
      ...
      <ConfirmDialog
        ...
        message={
          pendingDelete
            ? `"${pendingDelete.fullName}" (${pendingDelete.studentId}) will be deactivated and hidden from the register. This can be reversed from the database if needed.`
            : ""
        }
