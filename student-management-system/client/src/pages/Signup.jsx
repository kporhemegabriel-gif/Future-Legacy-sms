        ...
        <form onSubmit={handleSubmit} className="bg-paper border border-hairline p-6 space-y-4">
          <div>
            ...
            <p className="text-xs text-slate mt-1">
              This sets up the first administrator. Once created, self sign-up is disabled — this admin can invite additional staff accounts.
            </p>
          </div>
          ...
          <div>
            ...
            <input className="field-input" value={form.fullName} onChange={(e) => update("fullName", e.target.value)} required autoFocus />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="password" className="field-input" value={form.password} onChange={(e) => update("password", e.target.value)} required minLength={8} />
          </div>
          <div>
            <label className="field-label">Confirm Password</label>
            <input type="password" className="field-input" value={form.confirm} onChange={(e) => update("confirm", e.target.value)} required minLength={8} />
          </div>
          ...
          <p className="text-xs text-slate text-center pt-2">
            ...
            <button type="button" onClick={onSwitchToLogin} className="underline underline-offset-2 hover:text-ink">Log in</button>
          </p>
        </form>
      </div>
    </div>
